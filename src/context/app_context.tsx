...
export interface AppContextType {
  ...
  setMermaidSyntax: (value: string) => void;
  mermaidSyntaxError: string;
  setMermaidSyntaxError: (value: string) => void;
  selectedImage: ImageType | null;
  setSelectedImage: (value: ImageType | null) => void;
...
export const ContextProvider = ({
  ...
  const [mermaidSyntaxError, setMermaidSyntaxError] = useState<string>("");
  const [selectedImage, setSelectedImage] = useState<ImageType | null>(null);
  const [isLoadingDiagram, setIsLoadingDiagram] = useState<boolean>(false);
  const [panelStyle, setPanelStyle] = useState<string>("manga");
  const [gridType, setGridType] = useState<string>("3");
